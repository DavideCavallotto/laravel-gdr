            ...
            <form action="{{ route('characters.store') }}" method="POST" class="w-full max-w-lg">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="bio" name="bio">
                        </textarea>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="velocità" type="number" placeholder="Velocità" min="20" max="100" name="velocità">
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
